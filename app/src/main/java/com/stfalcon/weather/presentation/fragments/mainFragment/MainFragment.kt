package com.stfalcon.weather.presentation.fragments.mainFragment
...
import com.stfalcon.weather.databinding.FragmentMainBinding
import com.stfalcon.weather.di.appComponent
import com.stfalcon.weather.di.lazyViewModel
import com.stfalcon.weather.presentation.fragments.detailsBottomSheetFragment.DetailsBottomSheetFragment
import com.stfalcon.weather.presentation.providers.PermissionsRequestProvider
...
class MainFragment : Fragment(R.layout.fragment_main) {
    ...
    private fun setupCityButtons() {
        with(binding) {
        buttonKyiv.setOnClickListener { onCityButtonClicked("Kyiv") }
        buttonLviv.setOnClickListener { onCityButtonClicked("Lviv") }
        buttonKharkiv.setOnClickListener { onCityButtonClicked("Kharkiv") }
        buttonOdesa.setOnClickListener { onCityButtonClicked("Odesa") }
        buttonDnipro.setOnClickListener { onCityButtonClicked("Dnipro") }
        buttonZaporizhzhia.setOnClickListener { onCityButtonClicked("Zaporizhzhia") }
        }
    }
    private fun onCityButtonClicked(cityName: String) {
        // You can perform actions based on the clicked city name
        // For example, you can fetch weather information for the selected city
        viewModel.getWeatherByCityName(cityName)
    }
